...
Public Class Terminal_Inward_rpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Terminal_Inward_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project_Inventory.Terminal_Inward_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTerminal_Inward_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Terminal_Inward_rpt = New Terminal_Inward_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
