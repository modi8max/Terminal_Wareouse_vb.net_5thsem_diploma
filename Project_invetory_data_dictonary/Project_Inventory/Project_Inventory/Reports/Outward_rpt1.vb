...
Public Class Outward_rpt1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project_Inventory.Outward_rpt1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutward_rpt1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Outward_rpt1 = New Outward_rpt1()
        rpt.Site = Me.Site
        Return rpt
    End Function
